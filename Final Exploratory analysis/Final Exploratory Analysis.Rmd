...
---
title: "ElasticNet Regression Analysis and Predictive Modeling"
author: "Your Name"
output: html_document
---
...
```{r}
# Specify the relative path to the saved stargazer HTML file
file_path <- "output/fixed_effects_table_no_years.html"

# Use the includeHTML function to display the saved HTML content
