...
Below are the visualizations used in the analysis.

### Age Proportion Distribution Animation
![Debt-to-Income Ratios](age_proportion_distribution_animation.gif):/
...
![Tax Revenue Over Time](Visualizations/Aggregate State Tax Revenue by Year.jpeg)
...
### Elasticnet Output
![Elasticnet Output](Visualizations/Elasticnet output.png)
